...
### CODE I HAVE ADDED IS HERE FOR NOW ###
screen show_points:
    vbox:
        xalign 1.0
        yalign 0.0
        text "Pansy:[pansy_points]"
        text "Rula:[rula_points]"
        text "Sable: [sable_points]"
        text "Aurora:  [aurora_points]"
        text "Bea & Mona: [twins_points]"
        text "Alice: [alice_points]"
        text "Risby: [risby_points]"
...
screen show_day:
 ...
 ### CODE I HAVE ADDED ENDS HERE FOR NOW###
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Profiles") action ShowMenu("profile_screen")
            textbutton _("Skip") action Skip() alternate Skip(fast=True, confirm=True)
            textbutton _("Auto") action Preference("auto-forward", "toggle")
            textbutton _("Save") action ShowMenu('save')
            textbutton _("Q.Save") action QuickSave()
            textbutton _("Q.Load") action QuickLoad()
            textbutton _("Report an error") action OpenURL ("https://goo.gl/forms/xPpEtI1W0KNuBREx2")
...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Character Glossary") action ShowMenu("wiki_index")
